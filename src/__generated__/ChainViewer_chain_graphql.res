...
module Internal = {
  ...
  let fragmentConverter: 
    ...
    %raw(
      json`{"__root":{"actions_description":{"n":""},"actions_script_textualSource":{"n":""},"description":{"n":""},"libraryScript_concurrentSource":{"n":""},"actions_script_concurrentSource":{"n":""},"libraryScript_textualSource":{"n":""}}}`
    )
...
external getFragmentRef:
  RescriptRelay.fragmentRefs<[> | #ChainViewer_chain]> => fragmentRef = "%identity"
