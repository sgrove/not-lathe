...
function make(param) {
  ...
  return __x.then(function (fsMap) {
              ...
              var env = Vfs.createVirtualTypeScriptEnvironment(system, ["main.ts"], Typescript, {
                    o: true
                  });
              var program = Curry._1(env.languageService.getProgram, undefined);
              var typeChecker = Curry._1(program.getTypeChecker, undefined);
              Debug.assignToWindowForDeveloperDebug("tsSystem", system);
              ...
              return Promise.resolve(fsMap);
            });
}

function makeWithFileSystem(onCreateFileSystem) {
  var __x = Vfs.createDefaultMapFromCDN({
        target: Typescript.ScriptTarget.ES2015
      }, "3.7.3", true, Typescript);
  return __x.then(function (fsMap) {
              Curry._1(onCreateFileSystem, fsMap);
              var system = Vfs.createSystem(fsMap);
              var env = Vfs.createVirtualTypeScriptEnvironment(system, ["main.ts"], Typescript, {});
              var program = Curry._1(env.languageService.getProgram, undefined);
              var typeChecker = Curry._1(program.getTypeChecker, undefined);
...
Debug.assignToWindowForDeveloperDebug("makeFsMap", make);
...
function printType(flagOpt, typeChecker, typeNode, node, param) {
  ...
  return Curry._3(typeChecker.typeToString, typeNode, node, flag);
}
