...
module Gears = {
  @react.component
  let make = (~className=?, ~color="white", ~width="24", ~height="24") => {
    <svg ?className width height viewBox="0 0 418.879 418.879">
      <g>
        <g>
          <path
            fill=color
...
module Save = {
  @react.component
  let make = (~className=?, ~color="white", ~width="24", ~height="24") => {
    <svg ?className width height viewBox="0 0 453.03 453.03">
      <path
        fill=color
        d="M388.49,0H0.022v453.03h452.986V64.561L388.49,0z M385.017,221.834H110.68V25.691h274.337V221.834z"
      />
      <rect fill=color x="272.568" y="46.701" width="80.718" height="154.102" />
    </svg>
  }
}
...
module Link = {
  @react.component
  let make = (~className=?, ~color="white", ~width="24", ~height="24") => {
    <svg ?className width height viewBox="0 0 20 20" fill="none">
      <path
        fill=color
...
module RunLink = {
  @react.component
  let make = (~className=?, ~color="white", ~width="24", ~height="24") => {
    <svg ?className width height viewBox="0 0 17 10">
      <path
        ...
        fill=color
      />
      <path d="M12.5 4.33335V9.16667L16.6667 6.75L12.5 4.33335Z" fill=color />
      <path d="M9.16667 6.75H11.3333V8.33333H9.16667V6.75Z" fill=color />
      <path d="M16.6667 4.16667H15.0833L16.6667 5.34026V4.16667Z" fill=color />
    </svg>
  }
}
