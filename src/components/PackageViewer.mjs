...
import * as PackageViewer_oneGraphAppPackage_graphql from "../__generated__/PackageViewer_oneGraphAppPackage_graphql.mjs";

function use(fRef) {
  var data = Hooks.useFragment(PackageViewer_oneGraphAppPackage_graphql.node, fRef);
  return RescriptRelay_Internal.internal_useConvertedValue(PackageViewer_oneGraphAppPackage_graphql.Internal.convertFragment, data);
}

function useOpt(opt_fRef) {
  var fr = opt_fRef !== undefined ? Caml_option.some(Caml_option.valFromOption(opt_fRef)) : undefined;
  var nullableFragmentData = Hooks.useFragment(PackageViewer_oneGraphAppPackage_graphql.node, fr !== undefined ? Js_null_undefined.fromOption(Caml_option.some(Caml_option.valFromOption(fr))) : null);
  var data = (nullableFragmentData == null) ? undefined : Caml_option.some(nullableFragmentData);
  return RescriptRelay_Internal.internal_useConvertedValue((function (rawFragment) {
                if (rawFragment !== undefined) {
                  return PackageViewer_oneGraphAppPackage_graphql.Internal.convertFragment(rawFragment);
                }
...
function PackageViewer(Props) {
  ...
  var authTokens = Belt_Option.mapWithDefault(authTokensRef, [], (function (authTokensRef) {
          var oneGraphUser = use$1(authTokensRef);
