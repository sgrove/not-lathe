...
function Inspector$GitHub(Props) {
  ...
  var loadedChain = Belt_Array.getBy(Chain.loadFromLocalStorage(undefined), (function (chain) {
          return Caml_obj.caml_equal(chain.id, Belt_Option.map(savedChainId, Uuid.parseExn));
        }));
