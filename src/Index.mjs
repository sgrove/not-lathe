...
import * as Comps from "./components/Comps.mjs";
...
import * as ScriptEval from "./bindings/ScriptEval.mjs";
                          ...
                          className: "m-7"
                              ...
                              onSubmit: (function ($$event) {
                                  ...
                                  if (validConfig.TAG === /* Ok */0) {
                                    return onUpdated(validConfig._0);
                                  }
...
function $$default(param) {
  ...
  var state = match[0];
  React.useEffect((function () {
          var __x = import("./components/Studio.mjs");
